...
Como resultado, tem-se que garantindo a pré-condição expressa pela Equação \ref{eq:pre_condi_exemplo}, o Programa \ref{lst:codigo_simples_wp} terá o comportamento esperado e é funcionalmente correto.
