...
É importante ressaltar que para a análise de RTE do algoritmo PID, foi utilizado o modelo aritmético \emph{float} do \emph{WP}, que leva em consideração a forma como um \emph{float} é representado em memória em C, resultando então
...
Já para o algoritmo de  filtro foi utilizado e o plugin EVA, 
