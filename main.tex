...
de buffers, validade de regiões de memória e comportamento esperado de iterações. Ao longo do processo, diversas limitações práticas foram identificadas: certas estruturas da biblioteca eram
...
Observa-se, portanto, que WP/Jessie, RTE e EVA são complementares: provas dedutivas permitem demonstrar propriedades lógicas profundas e rigorosas, enquanto análises automáticas baseadas em
interpretação abstrata oferecem escalabilidade e detecção eficaz de potenciais \emph{runtime errors}. Essa complementaridade já é discutida em estudos mais amplos
\cite{cofer2012,rushby2011,delmas2012}, que defendem fluxos híbridos de verificação. No contexto industrial, essa integração tem se tornado cada vez mais alinhada com práticas exigidas por organismos
certificadores e com o avanço de iniciativas educacionais e metodológicas como as apresentadas por Blanchard \cite{blanchard2020introduction} e Kosmatov et al. \cite{kosmatov2024guide}. O conjunto dos
trabalhos revisados evidencia que, embora o uso de métodos formais exija esforço técnico significativo, sua aplicação prática tem produzido resultados consistentes e alinhados às exigências de
