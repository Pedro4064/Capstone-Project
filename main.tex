...
\subsection{Controlador PID}
O fonte código que implementa um controlador PID, no contexto de um sistema embarcado controlando um sinal de tensão 
analógico com amplitude de $-3.300mV$ a $+3.300mV$ e tendo como atuador um conversor digital analógico (DAC) de amplitude $0mV$ a $3.300mV$ é representado abaixo:
...
A principal estratégia abordada utilizadando os \emph{asserts} foi a induzir os \emph{solvers} automáticos a verificarem
verdades sobre o estado das variáveis em pontos estratégicos do código, principalmente antes e depois de operações com ponto flutuante.
O objectivo não éra definir o valor de cada variável em cada ponto, mas sim forçar os solvers a indentificarem propriedades.
