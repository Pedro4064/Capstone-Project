...
WP e EVA, na  verificação de ausência de erros em tempo de execução e corretude funcional de implementações na linguagem C de dois algoritmos utilizados em sistemas embarcados: o controlador PID e o
...
\section{Introdução}
    ...
    \subsection{Estrutura do Trabalho}
        ...
        \ref{chap:resultados}, por fim, apresenta os resultados das verificações feitas, assim como os desafios e métodos alternativos utilizados para supera-los.
...
que visa garantir a ausência de erros em tempo de execução e a corretude funcional dos programas, uitilizando ferramentas open-source: A Verificação Formal.
...
viável utilizando soluções inteiramente open-source. Apesar do custo inicial mais elevado — seja na redação de contratos, na compreensão das limitações dos analisadores ou na necessidade de ajustes
