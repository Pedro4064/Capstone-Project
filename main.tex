...
Controlador PID.
A verificação, mesmo tendo êxito, levantou algumas peculiaridades dos diferentes comportamentos a partir dos diferentes modelos tanto de memória quanto aritméticos utilizados e do estado atual das ferramentas utilizadas que resultaram em um trabalho considerável para garantir que \emph{solvers} automáticos
...
Já no segundo cenário, no qual foi utilizando os plugins \emph{EVA} e \emph{WP} para a análise de erros em tempo de execução e a corretude funcional, respectivamente, de um filtro de média móvel.
...
\emph{arrays}, e todas as implementações auxiliares necessárias para tal - resultando um total de 72 linhas de \emph{ACSL} e somente 15 para a implementação propriamente dita.
