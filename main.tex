...
Controlador PID.
A verificação, mesmo tendo êxito, levantou algumas peculiaridades do estado atual das ferramentas utilizadas que resultaram em um trabalho considerável para garantir que \emph{solvers} automáticos
fossem capazes de analizar corretamente o código fonte sem a necessidade de provas manuais. Tal trabalho está diretamente ligado as 
