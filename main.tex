...
Deseja-se determinar qual condição deve ser satisfeita antes da execução do programa representado pela Figura \ref{lst:codigo_simples_wp} (\emph{i.e qual a pré-condição}) para garantir que a pós-condição $x > 0$ seja
verdadeira ao final. Para isso, aplica-se o raciocínio regressivo (\emph{backwards-reasoning}), calculando a pré-condição mais fraca para cada comando, de forma que se mantenha a validade da
pós-condição ao término da execução.

\vspace{5px}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.17\textwidth]{img/teoria_pos_cond.png}
    \caption{Código com Pós-Condição Desejada}
    \label{lst:codigo_simples_wp}
\end{figure}
\vspace{5px}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.2\textwidth]{img/teoria_pos_cond_anotada.png}
    \caption{Código com Pós-Condição Desejada Anotado}
    \label{lst:codigo_simples_wp_anotado}
\end{figure}
\vspace{5px}


Como resultado, tem-se que garantindo a pré-condição expressa pela Equação \ref{eq:pre_condi_exemplo}, o programa da Figura \ref{lst:codigo_simples_wp} terá o comportamento esperado e é funcionalmente correto.
...
facilitar o processo de verificação é apresentado na Figura \ref{lst:codigo_media_movel_sem_acsl}.
\vspace{10px}
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{img/filtro_codigo_fonte.png}
    \caption{Implementação - Média Móvel.}
    \label{lst:codigo_media_movel_sem_acsl}
\end{figure}
\vspace{10px}
\subsubsection{Verificação de RTE}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{img/filtro_contexto.png}
    \caption{Utilização - Média Móvel.}
    \label{lst:utilizacao_filtro}
\end{figure}
\vspace{10px}
...
referente à falta da implementação ou de uma especificação para a função da HAL \emph{rtos\_sample\_adc}, como observado na Figura \ref{fig:resultado_preliminar_rte_eva_filtro}.
...
\begin{figure}[h]
    ...
    \label{fig:resultado_preliminar_rte_eva_filtro}
\end{figure}
\vspace{5px}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{img/filtro_contrato_rtos.png}
    \caption{Faixa de Valores e Contratos Limitadores - Média Móvel.}
    \label{lst:utilizacao_filtro}
\end{figure}
\vspace{5px}
\begin{figure}[h]
...
nos contratos que representarão a funcionalidade esperada de cada uma das duas funções. Resultando nos  contratos 
preliminares apresentados na Figura \ref{lst:contratos_preliminares}.

\vspace{5px}
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{img/filtro_contratos_preliminares.png}
    \caption{contratos Preliminares - Média Móvel.}
    \label{lst:contratos_preliminares}
\end{figure}
\vspace{5px}
...
utilizado para auxiliar os \emph{proovers} nos limites de divisão, ilustradas na Figura \ref{lst:efeitos_colaterais_filtro}.
\vspace{5px}
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{img/filtro_funcoes_logicas.png}
    \caption{Funções Lógicas e Efeitos Colaterais - Média Móvel.}
    \label{lst:efeitos_colaterais_filtro}
\end{figure}
\vspace{5px}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{img/filtro_invariantes_de_loop.png}
    \caption{Invariantes de Loop e Lemma - Média Móvel.}
    \label{lst:invariantes_filtro}
\end{figure}
\vspace{5px}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{img/filtro_ghost_code.png}
    \caption{Ghost Code e Asserts Auxiliares - Média Móvel.}
    \label{lst:ghost_code_filter}
\end{figure}
\vspace{5px}
